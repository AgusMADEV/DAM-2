# Criterios de evaluación — Actualización de registros con `UPDATE` en MySQL
...
- No usar `WHERE`, lo que podría modificar **todas las filas** de la tabla.  
- Olvidar `commit()`, lo que haría que el cambio no se guardase.  
- Fallar en la conexión o usar un identificador inexistente.
