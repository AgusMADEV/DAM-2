El proyecto desarrollado es un **Sistema ERP (Enterprise Resource Planning) Inteligente** que integra un asistente virtual basado en **Inteligencia Artificial** para facilitar la gestión empresarial mediante lenguaje natural.
...
**Tecnologías:** Python 3.8+, Flask, Ollama
...
function cargarProductos() {
    ...
    // Este código se ejecuta ANTES de que lleguen los datos
    console.log('Productos cargados'); // MENTIRA!
}
...
Este proyecto de ERP Inteligente integra los conocimientos del ciclo de DAM-2 en una aplicación funcional que combina gestión empresarial con inteligencia artificial.
