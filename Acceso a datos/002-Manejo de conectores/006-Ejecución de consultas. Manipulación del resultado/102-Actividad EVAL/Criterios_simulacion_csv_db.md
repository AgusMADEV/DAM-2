# Criterios de evaluación — Simulación de bases de datos con carpetas y archivos CSV
...
- No crear la carpeta `db` antes de ejecutar el script (causará un error con `os.listdir`).  
- No usar correctamente el punto y coma en la petición (`SHOW DATABASES;`).  
- Colocar archivos directamente en `db` sin subcarpetas (no se mostrarán como bases de datos).  
